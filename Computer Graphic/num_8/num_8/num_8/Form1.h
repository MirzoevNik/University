...
namespace num_8 {
	...
	private:
		...
		System::Collections::Generic::List< PColor > colors;
...
#pragma endregion
	...
	private: System::Void Form1_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
				 ...
				 for ( int i = 0; i < polygons.Count; i++ )
				 {
					 ...
					 Color polygon_color = Color::FromArgb( colors[i].r, colors[i].g, colors[i].b );

					 System::Drawing::Pen^ polygon_pen = gcnew Pen( polygon_color );
					 polygon_pen->Width = 1;
					 ...
					 if ( p2->Count > 0 )
					 {
						 ...
						 {
							 b = p2[j];
							 g->DrawLine( polygon_pen, a.x, a.y, b.x, b.y );
							 a = b;
						 }
						 
						 pFill( p2, image1, polygon_color, p_min, p_max, Color::Green );
					 }
				 }
							 ...
							 if ( ( str.find_first_not_of(" \t\r\n") != std::string::npos ) && ( str[0] != '#' ) )
							 {
								 ...
								 else if ( cmd == "polygon" )
								 {
									 ...
									 for ( int i = 0; i < num_point; i++ ) 
									 {
										...
										s >> p.x >> p.y;
										pol->Add( p );
									 }									 polygons.Add( pol );									 PColor polygon_color;									 polygon_color.r = r;									 polygon_color.g = g;									 polygon_color.b = b;									 colors.Add( polygon_color );
								 }
								 else if ( cmd == "color" )
								 {
									 s >> r >> g >> b;
