...
namespace methodeWong {
	...
	private: System::Windows::Forms::ToolStripMenuItem^  открыть‘айл√руппыToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->открыть‘айл√руппыToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			// меню
			// 
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) {this->открыть‘айл√руппыToolStripMenuItem});
			...
			// 
			// открыть‘айл√руппыToolStripMenuItem
			// 
			this->открыть‘айл√руппыToolStripMenuItem->Name = L"открыть‘айл√руппыToolStripMenuItem";
			this->открыть‘айл√руппыToolStripMenuItem->Size = System::Drawing::Size(142, 20);
			this->открыть‘айл√руппыToolStripMenuItem->Text = L"ќткрыть файл группы";
			this->открыть‘айл√руппыToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form1::открыть‘айл√руппыToolStripMenuItem_Click);
			// 
			// открыть файл группы
			// 
...
#pragma endregion
	...
	private: System::Void Form1_Load(System::Object^  sender, System::EventArgs^  e) 
	{
		...
		открыть‘айл√руппыToolStripMenuItem_Click(sender,e);
	...
	private: System::Void открыть‘айл√руппыToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) 
	{
	...
	{
		var = comboBox1->SelectedIndex; // определение варианта студента
	}
